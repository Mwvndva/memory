...
void main() {
  ...
  group('Notifications Modernization Architecture Tests', () {
    test('State Manager ingests, orders, and de-duplicates events correctly', () async {
      ...
      notifier.handlePushNotification(
        ...
        'Hello!',
        {'id': 'msg-123', 'type': 'message', 'data': {'sender': 'Amara'}},
      );
    ...
    test('Read status management synchronizes lists and badge counts correctly', () async {
      final prefs = await SharedPreferences.getInstance();
