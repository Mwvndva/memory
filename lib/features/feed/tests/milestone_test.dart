...
void main() {
  group('Streak Milestones and Card Design Tests', () {
    test('CardDesignData.generate creates valid design data with shapes and colors', () {
    ...
    testWidgets('CircleMilestoneCardWidget renders circle milestone with member avatars correctly', (WidgetTester tester) async {
    ...
    testWidgets('CircleMilestoneCongratulationsDialog renders and closes correctly', (WidgetTester tester) async {
      ...
      expect(find.byType(CircleMilestoneCongratulationsDialog), findsOneWidget);
