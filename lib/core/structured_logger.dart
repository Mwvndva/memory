...
class StructuredLogger {
  static void log(String message, {String? category, dynamic error, StackTrace? stackTrace}) {
  ...
  static void logError(String message, {String? category, dynamic error, StackTrace? stackTrace}) {
    log('ERROR: $message', category: category, error: error, stackTrace: stackTrace);
  }
}
